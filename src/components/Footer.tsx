      ...
      <div className="mx-auto mt-16 grid max-w-7xl gap-14 px-6 md:grid-cols-12 md:px-10">
        <div className="md:col-span-5">
          <div className="flex items-center gap-3">
            ...
            <span className="font-display text-2xl tracking-[0.4em]">NEXORA</span>
          </div>
          <p className="mt-6 max-w-sm text-sm leading-relaxed text-muted-foreground">
            A futuristic luxury wellness universe — where the science of the mind meets
        ...
        <div className="md:col-span-3">
          ...
          <ul className="mt-5 space-y-3 text-sm text-muted-foreground">
            <li><a className="transition-colors hover:text-gold" href="#neuro">Neuroscience</a></li>
            <li><a className="transition-colors hover:text-gold" href="#music">Sound Journeys</a></li>
            <li><a className="transition-colors hover:text-gold" href="#wellness">Wellness</a></li>
            <li><a className="transition-colors hover:text-gold" href="#programs">Programs</a></li>
